  ...
  let build_function_body fdecl =
    ...
    let rec build_stmt (builder, local_vars, we_bb) = function
      ...
      | SIf (predicate, then_stmt, else_stmt) ->
        ...
        ignore (build_stmt ((L.builder_at_end context else_bb), local_vars, we_bb)  else_stmt);
      ...
      | SFor (s1, e1, e2, body) ->
        ...
        let builder2, _ = build_stmt (builder1, local_vars', we_bb) s2 in
        (builder2, local_vars)        
      | SWhile (predicate, body) ->
        ...
        add_terminal (fst (build_stmt ((L.builder_at_end context body_bb), local_vars, Some(end_bb)) body)) build_br_while;
